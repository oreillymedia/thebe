...
require(['base/js/namespace', 'jquery', 'notebook/js/notebook', 'contents', 'services/config', 'base/js/utils', 'base/js/page', 'base/js/events', 'notebook/js/actions', 'notebook/js/kernelselector', 'codemirror/lib/codemirror', 'custom/custom'], function(IPython, $, notebook, contents, configmod, utils, page, events, actions, kernelselector, CodeMirror, custom) {
  var Thebe;
  Thebe = (function() {
  ...
  $(function() {
    var thebe;
    return thebe = new Thebe("pre[data-executable]", 'http://jupyter-kernel.odewahn.com:8000/spawn');
  });
  return Thebe;
});
