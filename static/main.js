...
define(['./base/js/namespace', './components/jquery/jquery', './components/es6-promise/promise.min', './thebe/dotimeout', './notebook/js/notebook'], function(IPython, $, promise, doTimeout, notebook, jqueryCookie, default_css, contents, configmod, utils, page, events, actions, kernelselector, kernel, CodeMirror, terminado, Terminal, custom) {
  var Thebe;
  Thebe = (function() {
